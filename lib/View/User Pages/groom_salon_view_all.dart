...
class GroomViewAll extends StatelessWidget {
  const GroomViewAll({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final money = NumberFormat("#,##0", "en_US");
    final Stream<QuerySnapshot> usersStream = FirebaseFirestore.instance
        .collection('Bridal Salon').where('isPrivate' , isEqualTo: false)
