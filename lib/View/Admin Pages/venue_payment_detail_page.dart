...
class VenuePayment extends StatelessWidget {
  final QueryDocumentSnapshot userData;
  const VenuePayment({super.key, required this.userData});
              ...
              child: Table(
                ...
                children: [
                  ...
                  buildTableRow(
                      ...
                      value: userData['bookingCompleted']),
                  buildTableRow(
                  ...
                  buildTableRow(
                      name: 'venueBookedOn', value: userData['venueBookedOn']),
                  buildTableRow(name: 'venueId', value: userData['venueId']),
                  buildTableRow(
                      name: 'venueName', value: userData['venueName']),
                ],
              ),
            ),
            const Spacer(),
